...
export function ProductCard({ product, onClick, colClass = "" }: Props) {
  return (
    <div className={`px-[6px] flex flex-col ${colClass}`}>
      <div
      ...
      >
        ...
        {/* Frame */}
        <div
          className="relative w-full aspect-square border overflow-hidden flex items-center justify-center transition-all duration-200 group-hover:shadow-pink-glow"
          style={{
          ...
          onMouseEnter={(e) => {
            ...
            el.style.boxShadow = "0 0 18px rgba(255,45,255,0.28)"
          }}
          onMouseLeave={(e) => {
            const el = e.currentTarget as HTMLElement
        ...
        >
          ...
          >
            <span
              className="font-display text-[12px] tracking-[4px]"
              style={{ color: "var(--pink)", textShadow: "0 0 10px var(--pink)", fontFamily: "var(--font-bebas), sans-serif" }}
            >
              VIEW
            </span>
          </div>
        ...
        <div className="flex items-baseline justify-between mt-1 gap-1">
          <span
            className="font-serif-brand text-[7px] text-[#bbb] overflow-hidden text-ellipsis whitespace-nowrap flex-1 italic transition-colors duration-200 group-hover:text-[--pink]"
        ...
        <div
          className="text-[9px] mt-[2px] tracking-[1px] font-display"
...
export function EmptyCard({ colClass = "" }: { colClass?: string }) {
  return (
    <div className={`px-[6px] ${colClass}`}>
      <div className="w-full aspect-square border" style={{ borderStyle: "dashed", borderColor: "rgba(255,45,255,0.06)", background: "linear-gradient(135deg, #140018, #1e0026, #140014)" }}>
